        ...
        <section class="container">
          ...
          <div>
            <article class="comm-course-list">
              <ul class="of" id="bna">
                <li v-for="(course, index) in this.courses" :key="index">
                  <div class="cc-l-wrap">
        ...
        <section class="container">
          ...
          <div>
            <article class="i-teacher-list">
              <ul class="of">
                <li v-for="(teacher,index) in this.teachers" :key="index">
...
<script>
  ...
  export default {
    ...
    methods:{
      getTeacherList(){
        teacher.getTeacherPageList(1,4)
          .then(Response=>{
